...
//     // organize all the monthly counts by date and get the last count
//     const lastCount = inventory.inventoryGoods[0].monthlyCounts.sort((a, b) => {
//       return (
...
//     // find the index of the count in the monthlyCounts array
//     const countIndex = lastCount.findIndex(
//       (count: IInventoryCount) =>
//         (count._id ?? "").toString() === countId.toString()
//     );
...
//     //   inventory.inventoryGoods[0].monthlyCounts[countIndex]
...
//     // // return new NextResponse(
//     // //   JSON.stringify(updateInventoryCount),
//     // //   {
//     // //     status: 200,
//     // //     headers: { "Content-Type": "application/json" },
//     // //   }
...
//     //       "inventoryGoods.$[elem1].averageDeviationPercent": averageDeviationPercentCalculation,
//     //       "inventoryGoods.$[elem1].monthlyCounts.$[elem2]": updateInventoryCount, // Correctly reference monthlyCounts
//     //     },
//     //   },
//     //   {
//     //     arrayFilters: [
